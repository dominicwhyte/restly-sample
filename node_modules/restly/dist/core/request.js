...
const getUrl = (options) => {
    const encoder = OpenAPI_1.OpenAPI.ENCODE_PATH || encodeURI;
    const path = options.url
        .replace('{api-version}', OpenAPI_1.OpenAPI.VERSION)
...
const getFormData = (options) => {
    return { parameters: options.formData }; // this is hacky
    //   if (options.formData) {
...
exports.sendRequest = (options, url, body, formData, headers, onCancel) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield node_fetch_1.default(url, request);
});
 ...
 * @throws ApiError
 */
exports.request = (serviceName) => (options) => {
    return new CancelablePromise_1.CancelablePromise((resolve, reject, onCancel) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const url = getUrl(options);
            const body = { parameters: options.formData }; // hacky
            // const headers = await getHeaders(config, options);
            const headers = {
                serviceName,
                Accept: 'application/json',
                'Content-Type': 'application/json',
                Authorization: `bearer ${OpenAPI_1.OpenAPI.RESTLY_KEY}`
            };
            if (!onCancel.isCancelled) {
                const response = yield exports.sendRequest(options, url, body, null, headers, onCancel);
